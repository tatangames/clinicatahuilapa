        ...
        <div class="container-fluid">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">HISTORIAL DE SALIDA MANUAL DE ARTICULOS</h3>
                </div>
...
@section('archivos-js')
    ...
    <script>
        ...
        function verificarEstado(){
            ...
            // CARGAR TABLA
            var ruta = "{{ URL::to('/admin/historial/reporte/salidasmanual/tabla') }}/" + fechainicio + "/" + fechafin;
            $('#tablaDatatable').load(ruta);
        }



        function informacionImprimir(idordensalida){
