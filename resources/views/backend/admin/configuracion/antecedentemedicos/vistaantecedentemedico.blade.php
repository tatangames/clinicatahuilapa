...
<div id="divcontenedor" style="display: none">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Listado de Antecedentes Médicos</li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <div class="modal fade" id="modalEditar">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Editar Antecedente Médico </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/antecedentes/medico/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/antecedentes/medico/tabla/index') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function nuevo(){
            ...
            axios.post(url+'/antecedentes/medico/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(url+'/antecedentes/medico/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
                        ...
                        $.each(response.data.arraytipos, function( key, val ){
                            if(response.data.info.tipo_id == val.id){
        ...
        function editar(){
            ...
            axios.post(url+'/antecedentes/medico/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
