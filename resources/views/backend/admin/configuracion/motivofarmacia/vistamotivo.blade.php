...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/motivo/farmacia/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/motivo/farmacia/tabla/index') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function nuevo(){
            ...
            axios.post(url+'/motivo/farmacia/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(url+'/motivo/farmacia/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/motivo/farmacia/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
