        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Listado de Médicos</li>
                </ol>
            </div>
        </div>
    </section>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <br>
                                        <div>
                                            <select class="form-control" id="usuario-editar">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/medico/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/medico/tabla/index') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function nuevo(){
            ...
            if(usuario_id === ''){
                toastr.error('Usuario de Médico es requerido');
                return;
            }
            ...
            axios.post(url+'/medico/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            var usuario_id = document.getElementById('usuario-editar').value;
            ...
            axios.post(url+'/medico/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
