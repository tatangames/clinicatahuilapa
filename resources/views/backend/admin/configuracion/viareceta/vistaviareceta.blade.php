                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Tipo de Vía para Receta</label>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var ruta = "{{ URL::to('/admin/receta/via/tabla') }}";
    ...
    <script>
        ...
        function nuevo(){
            ...
            if(nombre === ''){
                toastr.error('Tipo de Vía es requerido');
                return;
            }
            ...
            axios.post(url+'/receta/via/registro', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(url+'/receta/via/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/receta/via/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
