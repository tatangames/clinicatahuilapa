        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Profesión</li>
                    <li class="breadcrumb-item active">Listado de Profesiones</li>
                </ol>
            </div>
        </div>
    </section>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/profesion/tabla/index') }}";
    ...
    <script>
        ...
        function nuevo(){
            ...
            axios.post(url+'/profesion/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(url+'/profesion/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/profesion/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
